...
import com.example.messages.registerlogin.RegisterActivity
import com.example.messages.views.LatestMessageRow
...
class LatestMessagesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewLatestMessages.layoutManager = LinearLayoutManager(this)
        ...
        adapter.setOnItemClickListener { item, view ->
            ...
            Log.d("LatestMessageActivity", "Showing chat from ${row.chatPartnerUser?.username}")
        }
    }
